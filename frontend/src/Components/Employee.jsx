...
//                   <p className=" rounded ml-4 p-1">{selectedEmployee.id}</p>
//                 </div>
//               )}
...
//               </div>
//               <div>
//                 <button onClick={handleOpenattendance}>view attendance</button>
//               </div>
...
//               <div className="p-2 mr-8 relative right-[50px] bottom-[50px]">
//                 <button
